...
func cloudAwsTemplatesPostgresTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "cloud/aws/templates/postgres.tmpl", size: 4430, mode: os.FileMode(436), modTime: time.Unix(1520015640, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func cloudAwsTemplatesRedisTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "cloud/aws/templates/redis.tmpl", size: 3164, mode: os.FileMode(436), modTime: time.Unix(1520015640, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
